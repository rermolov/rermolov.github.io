...
function GetCacheBaseName()
{
	...
	// e.g. "'GAME_NAME'__https://example.com/foo/" (won't collide with anything under bar/)
...
function GetCacheVersionName(version)
{
	...
	// e.g. "'GAME_NAME'__https://example.com/foo/-v2"
...
async function UpdateCheck(isFirst)
{
	try {
		...
		if (!fileList.includes("index.html" )) { fileList.unshift("./"); }
